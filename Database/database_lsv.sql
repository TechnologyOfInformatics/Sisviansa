/*
 ...
 (8, 7, NOW(), NULL);
 /*
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.cliente TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.empresa TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.vianda TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.conforma TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.vianda_dieta TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.menu TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.compone TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.pedido TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.stock TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.genera TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.asigna TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.paquete TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.paquete_esta TO your_role;
 
 GRANT SELECT, INSERT, UPDATE, DELETE ON SISVIANSA_TECHIN_V1.recibe TO your_role;
 */
/*
