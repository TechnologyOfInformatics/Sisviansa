...
CREATE TABLE web (
  ...
  documento_tipo VARCHAR(10) NOT NULL COMMENT 'Tipo de documento de identificacion del cliente web',
  documento_numero VARCHAR(11) NOT NULL COMMENT 'numero correspondiente al tipo de documento del cliente web',
