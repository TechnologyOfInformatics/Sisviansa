      ...
      <nav class="profile-sidebar__nav">
        <ul>
          <li
            ...
            :class="{
              'profile-sidebar__nav-item--active': selectedOption === 'Account',
            }"
          >
          ...
          <li
            @click="selectOption('OrderHistory')"
            :class="{
              'profile-sidebar__nav-item--active':
          ...
          <li
            @click="selectOption('ShippingAddress')"
            :class="{
              'profile-sidebar__nav-item--active':
          ...
          <li
            @click="selectOption('Customs')"
            :class="{
              'profile-sidebar__nav-item--active': selectedOption === 'Customs',
            }"
          >
