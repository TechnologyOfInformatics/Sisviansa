  ...
  <main>
    <div class="directions-container">
      <ul class="direction-list" v-if="Array.isArray(this.directions)">
          ...
          <div class="direction">
            ...
            <div class="star">
              <i
                ...
                v-if="direction.predeterminado == '1'"
              ></i>
            </div>
          </div>
        </li>
        ...
        <li
          v-for="n in 3 - directions.length"
          :key="n"
          class="direction-item-null"
        >
        ...
        <div class="modal-content directions">
          <div class="direction-item direction-item-modal">
            ...
            <div class="bottom-form">
              <input
                type="text"
                v-model="editingAddress.barrio"
                placeholder="Barrio"
              />
              <input
                type="text"
                v-model="editingAddress.calle"
                placeholder="Calle"
              />
              <input
                type="text"
                v-model="editingAddress.direccion"
                placeholder="Dirección"
              />
            </div>
          </div>
