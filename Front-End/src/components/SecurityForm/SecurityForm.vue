    ...
    <div class="form-container">
        ...
        <div class="user-form">
            ...
            <div class="form-password-data">
                <p id="error-length" class="error-message">Tu contraseña debe tener más de 8 caracteres</p>
                <p id="error-number" class="error-message">Tu contraseña debe tener al menos un número</p>
                <p id="error-letter" class="error-message">Tu contraseña debe tener al menos una letra</p>
                <p id="error-name" class="error-message">Tu contraseña no debe contener tu nombre</p>
                <p id="error-match" class="error-message">Las contraseñas deben coincidir</p>
            </div>
        </div>
    </div>
</template>
